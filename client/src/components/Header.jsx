...
const Header = ({ onLogout, partnerStatus }) => {
  ...
  const mockData = {
    'enrolling': { name: 'Enrollment Partner', email: 'partner1@asap.com', phone: '9000000001', address: 'ASAP Kerala HQ, Trivandrum', type: 'Applicant' },
    'audit_round_1': { name: 'Audit Partner', email: 'partner2@asap.com', phone: '9876543210', address: 'Cyberpark, Kozhikode, KL', type: 'Private Centre' },
    'physical_verification': { name: 'Verification Partner', email: 'partner3@asap.com', phone: '9446000000', address: 'Technopark, Trivandrum, KL', type: 'Government Aided' },
